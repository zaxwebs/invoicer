				...
				<div class="flex flex-col justify-between h-screen p-4">
					<div>
						...
						<ul class="flex flex-col space-y-1">
							<li>
								<a @class(['bg-white/10' => request()->routeIs('dashboard'), 'flex items-center gap-x-3.5 py-3 px-4 text-white rounded-lg hover:bg-white/10 focus:outline-none focus:bg-white/10 dark:bg-neutral-700 dark:text-white'])
							...
							<li>
								<a @class(['bg-white/10' => request()->routeIs('settings.edit'), 'flex items-center gap-x-3.5 py-3 px-4 text-white rounded-lg hover:bg-white/10 focus:outline-none focus:bg-white/10 dark:bg-neutral-700 dark:text-white'])
